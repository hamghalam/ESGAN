...
def load_data(dset, image_data_format):
  train_split = 0.8 
 # X_full = np.load('/home/mohammad/Flair_HighContrast2364.npy')
 # X_sketch = np.load('/home/mohammad/Flair_original2364.npy')
  X_full       = np.load('/home/mohammad/Flair_highContrast_all_32_m1.npy')  # Flair_HighContrast2_64_5  Flair_HighContrast23
  X_sketch     = np.load('/home/mohammad/Flair_original_all_32_m1.npy')      # Flair_original2_64_5      Flair_original23
  target_class = np.load('/home/mohammad/target_flair_all_32_m1.npy')              # target2_64_5              target23 
  ...
  training_idx, test_idx = indices[:int(X_full.shape[0]*train_split)], indices[int(X_full.shape[0]*train_split):]
  X_full_train, X_full_val = X_full[training_idx,:], X_full[test_idx,:]
  X_sketch_train, X_sketch_val = X_sketch[training_idx,:], X_sketch[test_idx,:]
  target_train,target_val =  target_class[training_idx,:], target_class[test_idx,:]

  return X_full_train, X_sketch_train, X_full_val, X_sketch_val,target_train,target_val
